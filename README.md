# Tuya IoTOS Embeded Demo BLE laser emit
...
This Demo is based on Tuya Smart Cloud Platform, Tuya Smart APP, IoTOS Embeded Ble SDK, and uses Tuya BLE series modules to quickly set up a laser module demo with remote control of laser emission.
